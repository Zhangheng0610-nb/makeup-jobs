...
5. **质量门槛与写文件时机（硬性）**：
   - 先按**扩大搜索矩阵**搜 18-25 个查询：区县（鄞州/海曙/江北/镇海/北仑/奉化/慈溪/余姚/宁海/象山）× 平台（58/智联/前程无忧/全职网/店长直聘/全影/象山明聘/宁波招聘网）× 岗位（化妆师/彩妆/造型/跟妆/儿童/助理/摄影师）。**每次更新必须换新关键词、扩大覆盖面**（可加"2026年8月""最新""新店""高薪""诚聘"等变化词），禁止只复用上次的查询；搜到新公司/新平台继续深挖该公司其他岗位
